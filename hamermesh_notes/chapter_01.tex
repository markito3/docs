...
{\bf Definition: cycle structure} (p.\ 25): A permutaiton which when resolved into independent cycles has $\nu_1$ 1-cycles, $\nu_2$ 2-cycles,..., $\nu_n$ $n$-cycles is said to have the cycle structure $(1^{\nu_1},2^{\nu_2},...,n^{\nu_n})$, or briefly $\nu$.
...
For solution to the other problem on p.27, see class\_count.pdf. Note that each class has a cycle structure denoted by $(\nu)$. 
