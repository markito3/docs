...
sides gives $b=c$. So transformations by the same member ($a$) must be
unique, since no transformation of distinct members can map to the
same member ($b$ must be the same as $c$).
