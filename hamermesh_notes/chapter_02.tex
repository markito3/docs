...
{\bf Restatement of ``adjoin only a two-fold axis. This axis must be a right angles to the $n$-fold
...
{\bf Question: why must there be $n$ two-fold axes perpendicular to
  the $n$-fold axis?} (p.\ 43) If we start by adding one such axis,
transformations about an axis at $2\pi/n$ from the original axis can
be generated by a transformation of the original axis. $n$ of these
can be generated.
