...
{\bf Definition of a two-sided axis} (p.\ 39) Whenever there is a rotation in the group which carries $A^\prime A$ into $AA^\prime$, we say that $A^\prime A$ is a {\it two-sided axis}.
