...
less than $\pi$ and thier corresponding rotations in equal and
opposite directsion. Each member of a pair can be tranformed in to
other by a rotation about the x-axis.

{\bf Explicit demonstration of class membership for a pair of rotations} (p.\ 43) Consider $n=6$. For a point at $10^\circ$, a rotation by $60^\circ$ leaves the point at $70^\circ$. Transformation by of a rotation of $-60^\circ$ by a rotation about the $x$-axis moves the point from 10 to $-$10 to $-$70 to $70^\circ$. So rotations of $60^\circ$ and $-60^\circ$ are in the same class. There is also a two-fold axis at $60^\circ$. Using that axis to do the transformation moves the point at $10^\circ$ to $110^\circ$ to $50^\circ$ to $70^\circ$. So [probably] any two-fold axis can be used to transform a $-60^\circ$ rotation to a $60^\circ$ rotation.
