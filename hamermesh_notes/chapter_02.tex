...
{\bf Definition of equivalent axes} (p.\ 38) All the axes (or planes) which can be brought into coincidence by some operation of the group are said to be equivalent axes (or planes). Comment: here axis refers to the axis of rotation for a member of the symmetry group. Likewise plane refers to a plane of reflection for a member of the group.

{\bf Definition of a two-sided axis} (p.\ 39) Whenever there is a rotation in the group which carries $A^\prime A$ into $AA^\prime$, we say that $A^\prime A$ is a {\it two-sided axis}. Note this is not the same as a two-fold axis.
