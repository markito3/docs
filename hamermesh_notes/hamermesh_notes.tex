...
{\bf p.\ 8, Order of a group element}. If all powers of an element $a$ are distinct, then $a$ is of {\it infinite order}. If $n$ is the smallest integer such that $a^n = e$ then $n$ is the order of the element $a$.
...
The cyclic group is \href{https://en.wikipedia.org/wiki/Cyclic_group}{defined on Wikipedia}.
