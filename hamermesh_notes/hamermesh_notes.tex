...
\begin{quote}
$a$ cannot be $e$ since $a^2 = e$ and $a$ is a member of a group of order 1. $a^2$ cannot be $e$ otherwise $aa^2 = a^3$ would be equal to $a$ and thus $a$ and $a^3$ would not be distinct.
\end{quote}
...
\begin{quote}
  ...
  imply that $b = a^{-1}$ but $a^{-1} = a^2$ which $b$ is distinct
